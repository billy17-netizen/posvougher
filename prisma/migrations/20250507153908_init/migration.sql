...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_cashierUserId_fkey" FOREIGN KEY ("cashierUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
